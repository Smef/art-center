    ...
    <ActionSection>
        ...
        <template #content>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-surface-600 dark:text-surface-400">
                        <p
                            v-if="confirming"
                            class="font-semibold"
                        >
                    ...
                    <div
                        v-if="setupKey"
                        class="mt-4 max-w-xl text-sm text-surface-600 dark:text-surface-400"
                    >
                ...
                <div v-if="recoveryCodes.length > 0 && !confirming">
                    ...
                    <div
                        class="mt-4 grid max-w-xl gap-1 bg-surface-100 px-4 py-4 font-mono text-sm rounded-border dark:bg-surface-800"
                    >
                        <div

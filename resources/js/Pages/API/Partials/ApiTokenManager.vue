...
<template>
    <div>
        ...
        >
            ...
            <template #content>
                ...
                <div
                    ...
                    class="mt-4 break-all rounded bg-surface-100 px-4 py-2 font-mono text-sm text-gray-500"
                >
            ...
            <template #footer>
                <ButtonSecondary @click="displayingToken = false"> Close</ButtonSecondary>
            </template>
        </DialogModal>
        ...
        >
            ...
            <template #footer>
                <ButtonSecondary @click="managingPermissionsFor = null"> Cancel</ButtonSecondary>
        ...
        >
            ...
            <template #footer>
                <ButtonSecondary @click="apiTokenBeingDeleted = null"> Cancel</ButtonSecondary>
